      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-soft border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div className="mt-2">
                  ...
                  <div className="flex gap-1">
                    <div className={`h-1 flex-1 rounded ${
                      passwordValidation.strength === 'weak' ? 'bg-red-500' : 'bg-gray-200'
                    }`}></div>
                    <div className={`h-1 flex-1 rounded ${
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-all duration-200"
          >
        ...
        <div className="mt-8 space-y-3">
          <div className="flex items-center space-x-3 p-3 bg-white rounded-xl shadow-card border border-gray-100">
            <div className="flex-shrink-0 w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center">
              <span className="text-xl">✅</span>
            </div>
            <p className="text-sm text-gray-700 font-medium">Sınırsız başvuru takibi</p>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-white rounded-xl shadow-card border border-gray-100">
            <div className="flex-shrink-0 w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center">
              <span className="text-xl">🤖</span>
            </div>
            <p className="text-sm text-gray-700 font-medium">AI destekli CV analizi</p>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-white rounded-xl shadow-card border border-gray-100">
            <div className="flex-shrink-0 w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center">
              <span className="text-xl">✍️</span>
            </div>
            <p className="text-sm text-gray-700 font-medium">Otomatik ön yazı oluşturma</p>
          </div>
        </div>
      </div>
    </div>
