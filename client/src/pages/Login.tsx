...
export const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.error?.message || 'Giriş başarısız. Lütfen bilgilerinizi kontrol edin.';
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-xl mb-4">
            <span className="text-white text-3xl sm:text-4xl font-bold">JT</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">
            JobTrackr
          </h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-soft border border-gray-100 dark:border-gray-700 p-6 sm:p-8">
          ...
          <button
            type="button"
            onClick={() => {
              window.location.href = 'https://jobtrackr-production-029f.up.railway.app/api/auth/google';
            }}
        ...
        <div className="mt-8 grid grid-cols-3 gap-3 sm:gap-4 text-center">
          <div className="p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-xl shadow-card border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium">Kolay Takip</p>
          </div>
          <div className="p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-xl shadow-card border border-gray-100 dark:border-gray-700">
            <div className="text-2xl sm:text-3xl mb-1">🤖</div>
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium">AI Analiz</p>
          </div>
          <div className="p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-xl shadow-card border border-gray-100 dark:border-gray-700">
            <div className="text-2xl sm:text-3xl mb-1">✨</div>
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium">Profesyonel</p>
          </div>
        </div>
      </div>
    </div>
